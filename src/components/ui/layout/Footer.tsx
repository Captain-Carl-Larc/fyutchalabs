...
export default function Footer() {
  ...
  return (
    <footer className="bg-zinc-950 border-zinc-800 border-t">
      <div className="mx-auto px-4 sm:px-6 lg:px-8 py-16 lg:py-20 max-w-7xl">
        ...
        {/* ── Bottom bar ──────────────────────────────── */}
        <div className="flex sm:flex-row flex-col justify-between items-center gap-4 mt-16 pt-8 border-zinc-800 border-t">
